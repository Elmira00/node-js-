...
function Auth() {
  rl.question("Enter the your username : ", (name) => {
    username = name;

    rl.question("Enter the your password : ", async (pass) => {
      password = pass;
...
function chooseMode() {
  rl.question(
    ...
    (choice) => {
      if (choice === "1") {
        mode = "private";
        rl.question("Enter the username to chat with : ", async (user) => {
          target = user;
        ...
        mode = "room";
        rl.question("Enter the room name : ", async (room) => {
          target = room;
